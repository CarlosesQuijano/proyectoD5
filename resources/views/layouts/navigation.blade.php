            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <i class="fa-solid fa-landmark fa-2xl" style="color: #781c31;"></i>                        {{ __('Dashboard') }}

                    </x-nav-link>

                    <x-nav-link :href="route('alumno.index')" :active="request()->routeIs('alumno.index')">
                        <i class="fa-sharp fa-solid fa-users fa-2xl" style="color: #781c31;"></i>                        {{ __('Alumnos') }}
                    </x-nav-link>
                    <x-nav-link :href="route('maestro.index')" :active="request()->routeIs('maestro.index')">
                        <i class="fa-solid fa-chalkboard-user fa-2xl" style="color: #781c31;"></i>                        {{ __('Maestros') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('clase.index')" :active="request()->routeIs('clase.index')">
                        <i class="fa-solid fa-book fa-2xl" style="color: #781c31;"> </i>    {{ __('Clases') }}
                    </x-nav-link>
                    @endrole
